...
function Logo({ className }: LogoProps) {
  return (
    ...
    >
      <g
        className="text-current fill-black dark:fill-white stroke-black dark:stroke-white"
        fillRule="evenodd"
      >
        <path
        ...
        />
        <path
          className="fill-black dark:fill-white stroke-black dark:stroke-white text-primary"
