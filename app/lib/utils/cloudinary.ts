...
function getLowQualityUrlFor(url: string, extension: string = 'webp') {
  ...
  return `https://res.cloudinary.com/${ENV.CLOUDINARY_CLOUD_NAME}/image/upload/w_50/${filename}.${extension}`
}
...
function buildSrc(
  ...
  return `https://res.cloudinary.com/${ENV.CLOUDINARY_CLOUD_NAME}/image/upload/w_${width}/${filename}.${format}`
}
