...
category: blog
heroImg:
  src: /uploads/blog/project-management-tools.jpg
  alt: 'Colorful sticky notes on a whiteboard'
  credit:
    name: Walls.io
    url: https://www.pexels.com/photo/colorful-sticky-notes-on-a-board-15543126/
    source: pexels
excerpt: >
  Throughout the years, I've worked with all sorts of tooling to keep track of
...
![post-its on a
wall](/uploads/blog/the-love-and-hate-relationship-between-developers-and-project-management-tools/meeting.jpg 'Photo by fauxels on Pexels')
...
![headbutting
buffalo's](/uploads/blog/the-love-and-hate-relationship-between-developers-and-project-management-tools/planning.jpg 'Photo by fauxels on Pexels')
