...
heroImg:
  ...
  credit:
    name: Lee Campbell
    url: https://unsplash.com/@iamleecampbell
    source: unsplash
excerpt: >
...
![create-remix command](/images/blog/frrrip-throwing-remix.run-into-the-mix-my-first-impressions.png 'create-remix command')
