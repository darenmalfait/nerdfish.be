...
1. fix: a commit of the type_fix patches a bug in your codebase (this correlates
   with PATCH in Semantic Versioning).
2. feat: a commit of the type_feat introduces a new feature to the codebase
