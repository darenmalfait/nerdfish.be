...
there, and you can continue to make additional changes or create a new commit to
include them.
...
So, git reset --soft allows you to undo a commit but keep all the changes while
git reset --hard will undo the commit and discard all the changes.
