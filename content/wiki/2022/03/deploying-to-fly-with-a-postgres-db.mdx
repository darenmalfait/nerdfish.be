...
Everything is ready, and now you can commit and push your changes to your repo. Every commit to your \`main\` branch will trigger a deployment to your production environment, and every commit to your \`dev\` branch will trigger a deployment to your staging environment.Deploying to fly with a Postgres db
