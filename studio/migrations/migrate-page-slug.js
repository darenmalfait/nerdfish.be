...
// Run this script with: `sanity exec --with-user-token migrations/migrateBlocks.js`
//
...
const fetchDocuments = () =>
  client.fetch(
    `*[_type == 'page' && defined(pageSlug)][0...100] {_id, _rev, pageSlug}`,
  )
...
const migrateNextBatch = async () => {
  ...
  if (patches.length === 0) {
    console.info('No more documents to migrate!')
    return null
  }
  console.info(
    `Migrating batch:\n %s`,
